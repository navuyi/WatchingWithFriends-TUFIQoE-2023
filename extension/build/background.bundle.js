...
var STORAGE_DEFAULT = {
    experiment_settings: {
        stats_record_interval_ms: 1 * 1000,
...
chrome.runtime.onInstalled.addListener(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("[BackgroundScript] | ".concat((0,_utils_time_utils__WEBPACK_IMPORTED_MODULE_2__.get_local_datetime)(new Date()), " | Installing..."));
                // Initialize local storage || WARNING --> THIS RESETS ALL chrome.storage KEYS TO DEFAULT VALUES
                return [4 /*yield*/, _utils_custom_ChromeStorage__WEBPACK_IMPORTED_MODULE_3__.ChromeStorage.initialize_default()
                    // Handle cadmiumPlayercore request blocking and injecting modified version
                ]; // same as --> chrome.storage.local.set(STORAGE_DEFAULT)
            case 1:
                // Initialize local storage || WARNING --> THIS RESETS ALL chrome.storage KEYS TO DEFAULT VALUES
                _a.sent(); // same as --> chrome.storage.local.set(STORAGE_DEFAULT)
                // Handle cadmiumPlayercore request blocking and injecting modified version
...
chrome.action.onClicked.addListener(function (tab) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(tab && tab.id)) return [3 /*break*/, 2];
                return [4 /*yield*/, chrome.tabs.update(tab.id, {
                        url: "setup.html"
                    })];
            case 1:
                _a.sent();
...
var controller = new _modules_Controller__WEBPACK_IMPORTED_MODULE_0__.Controller();
controller.init();
/**
...
*/
var receive_finished_signal = function (message, sender, sendResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var tabId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(message.header === _config_messages_config__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_HEADERS.FINISHED)) return [3 /*break*/, 2];
                if (!sender.tab) return [3 /*break*/, 2];
                tabId = Number(sender.tab.id);
                return [4 /*yield*/, chrome.tabs.update(tabId, {
                        url: "break.html"
                    })];
            case 1:
                _a.sent();
...
var receive_redirect_signal = function (message, sender, sendResponse) { return __awaiter(void 0, void 0, void 0, function () {
    var tabId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!(message.header === _config_messages_config__WEBPACK_IMPORTED_MODULE_1__.MESSAGE_HEADERS.REDIRECT)) return [3 /*break*/, 2];
                if (!sender.tab) return [3 /*break*/, 2];
                tabId = Number(sender.tab.id);
                return [4 /*yield*/, chrome.tabs.update(tabId, {
...
var NETFLIX_WATCH_URL = "https://www.netflix.com/watch";
var Controller = /** @class */ (function () {
    function Controller() {
        ...
        this.injectScript = function (tabId) { return __awaiter(_this, void 0, void 0, function () {
            var variables, running, mode, content_script;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, _utils_custom_ChromeStorage__WEBPACK_IMPORTED_MODULE_0__.ChromeStorage.get_experiment_variables()];
                    case 1:
                        variables = _a.sent();
                        running = variables.extension_running;
                        mode = variables.extension_mode;
                        if (running === false) {
    ...
    Controller.prototype.listenForVideoStart = function () {
        ...
        */
        ...
        chrome.webNavigation.onCompleted.addListener(function (details) {
            _this.logger.log("ON COMPLETED");
            _this.logger.log(details);
            if (details.frameId === 0 && details.url.includes(NETFLIX_WATCH_URL)) {
                chrome.tabs.get(details.tabId, function (tab) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!(tab.url === details.url)) return [3 /*break*/, 2];
                                this.logger.log("Entered Netflix Video Player");
                                return [4 /*yield*/, this.injectScript(details.tabId)];
                            case 1:
                                _a.sent();
                                _a.label = 2;
                            case 2: return [2 /*return*/];
...
var ChromeStorage = /** @class */ (function () {
        ...
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, chrome.storage.local.set(_config_storage_config__WEBPACK_IMPORTED_MODULE_0__.STORAGE_DEFAULT)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    ChromeStorage.set_single = function (key, data) { return __awaiter(void 0, void 0, void 0, function () {
        var _b;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, chrome.storage.local.set((_b = {},
                        _b[key] = data,
                        _b))];
                case 1:
                    _c.sent();
    ...
    ChromeStorage.get_single = function (key) { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, chrome.storage.local.get([key])];
                case 1:
                    res = _b.sent();
    ...
    ChromeStorage.get_multiple = function () {
        var keys = [];
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(_a, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, chrome.storage.local.get(__spreadArray([], keys, true))];
    ...
    ChromeStorage.get_experiment_variables = function () { return __awaiter(void 0, void 0, void 0, function () {
        var experiment_variables;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ChromeStorage.get_single("experiment_variables")];
                case 1:
                    experiment_variables = _b.sent();
                    return [2 /*return*/, experiment_variables];
            }
        });
    }); };
    ChromeStorage.set_experiment_variables = function (variables) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, chrome.storage.local.set({ experiment_variables: variables })];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    ChromeStorage.update_experiment_variables_property = function (key, value) { return __awaiter(void 0, void 0, void 0, function () {
        var variables;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ChromeStorage.get_experiment_variables()];
                case 1:
                    variables = _b.sent();
                    variables[key] = value;
                    return [4 /*yield*/, ChromeStorage.set_experiment_variables(variables)];
                case 2:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    ChromeStorage.get_experiment_settings = function () { return __awaiter(void 0, void 0, void 0, function () {
        var experiment_settings;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ChromeStorage.get_single("experiment_settings")];
                case 1:
                    experiment_settings = _b.sent();
                    return [2 /*return*/, experiment_settings];
            }
        });
    }); };
    ChromeStorage.set_experiment_settings = function (settings) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, chrome.storage.local.set({ experiment_settings: settings })];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
    ...
    ChromeStorage.update_experiment_settings_property = function (key, value) { return __awaiter(void 0, void 0, void 0, function () {
        var settings;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, ChromeStorage.get_experiment_settings()];
                case 1:
                    settings = _b.sent();
                    settings[key] = value;
...
var CustomLogger = /** @class */ (function () {
    function CustomLogger(prefix, color) {
        if (color === void 0) { color = "white"; }
        var _this = this;
        this.log = function (content) {
            var prefix = "".concat(_this.prefix, " | ").concat((0,_time_utils__WEBPACK_IMPORTED_MODULE_0__.get_local_datetime)(new Date()), " |");
            _this.original_logger("".concat(prefix, " %c ").concat(content), "color: ".concat(_this.color));
        };
        this.prefix = prefix;
        this.color = color;
...
/* harmony export */ });
var get_local_datetime = function (object) {
    var year = object.getFullYear();
    var month = (object.getMonth() + 1).toString().padStart(2, "0");
    var day = object.getDate().toString().padStart(2, "0");
    var hours = object.getHours().toString().padStart(2, "0");
    var minutes = object.getMinutes().toString().padStart(2, "0");
    var seconds = object.getSeconds().toString().padStart(2, "0");
    var milliseconds = object.getMilliseconds().toString().padStart(3, "0");
    return "".concat(year, "-").concat(month, "-").concat(day, "T").concat(hours, ":").concat(minutes, ":").concat(seconds, ".").concat(milliseconds); // <-- Local datetime in extended ISO format ''YYYY-MM-DDTHH:MM:SS:XXX''
};
var get_local_datetime_and_timezone = function (object) {
    // Get the datetime
    var year = object.getFullYear();
    var month = (object.getMonth() + 1).toString().padStart(2, "0");
    var day = object.getDate().toString().padStart(2, "0");
    ...
    var seconds = object.getSeconds().toString().padStart(2, "0");
    var milliseconds = object.getMilliseconds().toString().padStart(3, "0");
    var datetime = "".concat(year, "-").concat(month, "-").concat(day, "T").concat(hours, ":").concat(minutes, ":").concat(seconds, ".").concat(milliseconds);
    // Get timezone offset in +/- HH:MM format
    var timezone_offset_min = object.getTimezoneOffset();
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("3936df3f0b89fb37e3d7")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "watching-with-friends-netflix-qoe-experiment:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatewatching_with_friends_netflix_qoe_experiment"] = (chunkId, moreModules, runtime) => {
